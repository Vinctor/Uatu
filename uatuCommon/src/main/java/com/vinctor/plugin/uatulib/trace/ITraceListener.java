...
public interface ITraceListener {
     ...
     */
    Object start(final String className, final String method, final String signature, Object[] args);
     ...
     */
    void end(Object id, final String className, final String method, final String signature, final Object returnObj);
}
